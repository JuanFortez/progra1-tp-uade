...
def interfaz_admin(matriz, reservas, reservas_clientes, registros, historial, clientes, abonos, abonos_clientes):
    """
...
def interfaz_cliente(
    ...
    while True:
        ...
        print("  2 - Solicitar abono (quincenal/mensual/semestral)")
        print("  3 - Salir\n")
